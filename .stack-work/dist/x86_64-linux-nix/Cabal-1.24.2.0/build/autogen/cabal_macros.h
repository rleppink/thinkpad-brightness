...
/* package thinkpad-brightness-0.2.0.0 */
#define VERSION_thinkpad_brightness "0.2.0.0"
#define MIN_VERSION_thinkpad_brightness(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
...
#define CURRENT_COMPONENT_ID "thinkpad-brightness-0.2.0.0"

#define CURRENT_PACKAGE_KEY "thinkpad-brightness-0.2.0.0"
